...
<form action="" method="POST">
    <div class="contenedor">
        <table>
            ...
            <tr><td>
                ...
                <select id="tipo_busqueda" name="tipo_busqueda">
                    <option value="id_tecnico">ID de Técnico</option>
                    <option value="nombre">Nombre de Técnico</option>
                </select><br><br>
            </td></tr>
            <tr><td>
        ...
        <tr><th class="encabezado">ID de Técnico</th><th class="encabezado">Nombre de Técnico</th><th class="encabezado"s>Teléfono</th></tr>
    <?php
    include 'TecnicoBuscarConsulta.php';
    ?>
        </table>
        </div>
        </form>
